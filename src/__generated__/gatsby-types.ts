...
type DonkeyImageQueryVariables = Exact<{ [key: string]: never; }>;


type DonkeyImageQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> } }> } };

type SEOSiteDataQueryVariables = Exact<{ [key: string]: never; }>;


type SEOSiteDataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'author' | 'url'>> }>, readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly childImageSharp: Maybe<{ readonly fixed: Maybe<Pick<ImageSharpFixed, 'src'>> }> } }> } };
